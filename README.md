...
- 📸 [Rendex Screenshot](https://github.com/copperline-labs/rendex-mcp) - Capture any webpage as PNG/JPEG screenshot via MCP. Full-page capture, dark mode, ad blocking, custom viewports. Remote hosted on Cloudflare Workers (zero install) or via npm.
